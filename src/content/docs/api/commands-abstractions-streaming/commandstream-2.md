...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Commands.Abstractions/Streaming/CommandStream.cs#L9)
...
**Implements:** [`IAsyncDisposable`](https://learn.microsoft.com/dotnet/api/system.iasyncdisposable), `IAsyncEnumerable<TChunk>`, `IBufferWriter<TChunk>`, [`ICommand`](/ergosfare.docs/api/commands-abstractions/icommand), [`IMessage`](/ergosfare.docs/api/core-abstractions/imessage)
