...
to the strongly-typed [`IAsyncHandler<TMessage>.HandleAsync(TMessage, ErgosfareContext)`](/ergosfare.docs/api/core-abstractions-handlers/iasynchandler-1#handleasynctmessage-ergosfarecontext) method.
