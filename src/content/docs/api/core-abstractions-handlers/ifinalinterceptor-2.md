...
[`IFinalInterceptor<TMessage, TResult>.Handle(TMessage, TResult?, Exception?, IExecutionContext)`](/ergosfare.docs/api/core-abstractions-handlers/ifinalinterceptor-2#handletmessage-tresult-exception-iexecutioncontext) returns nothing. Asynchronous final interceptors implement
...
| `executionContext` | [`IExecutionContext`](/ergosfare.docs/api/core-abstractions/iexecutioncontext) | The current execution context. |
