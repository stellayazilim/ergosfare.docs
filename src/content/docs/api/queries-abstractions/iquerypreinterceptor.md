...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Queries.Abstractions/PreInterceptors/IQueryPreInterceptor.cs#L14)

## Remarks

Because it accepts every query, this contract sees them as [`IQuery`](/ergosfare.docs/api/queries-abstractions/iquery) and
...
[`IQueryPreInterceptor<TQuery>`](/ergosfare.docs/api/queries-abstractions/iquerypreinterceptor-1).
