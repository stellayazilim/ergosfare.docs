...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Queries.Abstractions/ExceptionInterceptors/IQueryExceptionInterceptorFor%5BTException%5D.cs#L19)
...
| --- | --- | --- |
| `query` | [`IQuery`](/ergosfare.docs/api/queries-abstractions/iquery) | The query whose dispatch failed. |
