...
[View source](https://github.com/stellayazilim/ergosfare/blob/main/src/Stella.Ergosfare.Queries.Abstractions/Handlers/IStreamQueryHandler%5BTQuery%2CTResult%5D.cs#L21)

**Type parameters**

| Name | Description |
| --- | --- |
| `TQuery` | The type of the stream query being handled. Must implement [`IStreamQuery<TResult>`](/ergosfare.docs/api/queries-abstractions/istreamquery-1). |
