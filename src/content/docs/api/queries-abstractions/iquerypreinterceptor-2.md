...
[View source](https://github.com/stellayazilim/ergosfare/blob/main/src/Stella.Ergosfare.Queries.Abstractions/PreInterceptors/IQueryPreInterceptor%5BTQuery%2CTQuery%5D.cs#L27)

**Type parameters**

| Name | Description |
| --- | --- |
| `TQuery` | The type of query to intercept. Must implement [`IQuery`](/ergosfare.docs/api/queries-abstractions/iquery). |
