...
| [`IQueryPostInterceptor<TQuery>`](/ergosfare.docs/api/queries-abstractions/iquerypostinterceptor-1) | Interface | Represents a result-agnostic post-interceptor for a specific query type in the Stella.Ergosfare pipeline. |
