...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Queries.Abstractions/FinalInterceptors/IQueryFinalInterceptor.cs#L14)
...
implement [`IQueryFinalInterceptor<TQuery, TResult>`](/ergosfare.docs/api/queries-abstractions/iqueryfinalinterceptor-2).
