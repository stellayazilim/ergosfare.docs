...
It inherits from [`IAsyncFinalInterceptor<TMessage, TResult>`](/ergosfare.docs/api/core-abstractions-handlers/iasyncfinalinterceptor-2), enabling
asynchronous final processing of queries after they are dispatched to their handlers.

Query handlers and messages that implement [`IQuery`](/ergosfare.docs/api/queries-abstractions/iquery) will recognize
