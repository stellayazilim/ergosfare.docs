...
This interface combines [`IHandlerDescriptor`](/ergosfare.docs/api/core-abstractions-registry-descriptors/ihandlerdescriptor) for handler metadata
with [`IHasResultType`](/ergosfare.docs/api/core-abstractions-registry-descriptors/ihasresulttype) to indicate the type of result the handler produces.
