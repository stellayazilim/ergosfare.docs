...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Streaming/StreamInfo.cs#L23)
...
| `Completion` | [`StreamCompletion`](/ergosfare.docs/api/core-abstractions-streaming/streamcompletion) | How the stream ended, or [`StreamCompletion.Open`](/ergosfare.docs/api/core-abstractions-streaming/streamcompletion#open). |
...
How the stream ended, or [`StreamCompletion.Open`](/ergosfare.docs/api/core-abstractions-streaming/streamcompletion#open).

**Returns**

[`StreamCompletion`](/ergosfare.docs/api/core-abstractions-streaming/streamcompletion)
