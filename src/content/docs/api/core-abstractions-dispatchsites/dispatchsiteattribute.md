...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/DispatchSites/DispatchSiteAttribute.cs#L16)
...
| `kind` | [`DispatchKind`](/ergosfare.docs/api/core-abstractions-dispatchsites/dispatchkind) |  |
