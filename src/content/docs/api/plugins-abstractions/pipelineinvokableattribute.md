...
given [`PipelineInvokableAttribute.Hook`](/ergosfare.docs/api/plugins-abstractions/pipelineinvokableattribute#hook).
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Plugins.Abstractions/PipelineInvokableAttribute.cs#L65)
...
| --- | --- | --- |
| `hook` | [`Hook`](/ergosfare.docs/api/plugins-abstractions/hook) | The point in the pipeline to call the method at. |
