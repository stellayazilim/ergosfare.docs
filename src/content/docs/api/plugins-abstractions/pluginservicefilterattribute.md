...
Narrows which pipelines a plugin service's [`PipelineInvokableAttribute`](/ergosfare.docs/api/plugins-abstractions/pipelineinvokableattribute)
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Plugins.Abstractions/PluginServiceFilterAttribute.cs#L26)
...
There are two axes and only two. **Family** comes from [`Module`](/ergosfare.docs/api/plugins-abstractions/module), because
...
| --- | --- | --- |
| `modules` | [`Module`](/ergosfare.docs/api/plugins-abstractions/module) | The families to reach. |
...
The families this filter selects; [`Module.All`](/ergosfare.docs/api/plugins-abstractions/module#all) when it filters by key
instead.

**Returns**

[`Module`](/ergosfare.docs/api/plugins-abstractions/module)
