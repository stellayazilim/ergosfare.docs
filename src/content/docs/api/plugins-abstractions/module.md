...
[`PluginServiceFilterAttribute`](/ergosfare.docs/api/plugins-abstractions/pluginservicefilterattribute).
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Plugins.Abstractions/Module.cs#L15)
