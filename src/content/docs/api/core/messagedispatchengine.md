...
[`IMessageMediator`](/ergosfare.docs/api/core-abstractions/imessagemediator) executor path, with the calling scope's provider supplied
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core/MessageDispatchEngine.cs#L21)
...
supplies. Dispatch behavior matches [`IMessageMediator`](/ergosfare.docs/api/core-abstractions/imessagemediator)'s executor overloads
...
| `context` | [`IExecutionContext`](/ergosfare.docs/api/core-abstractions/iexecutioncontext) | The externally owned execution context. |
...
[`MessageDispatchEngine.DispatchAsync(object, IExecutionContext, IServiceProvider, IEnumerable<string>?)`](/ergosfare.docs/api/core/messagedispatchengine#dispatchasyncobject-iexecutioncontext-iserviceprovider-ienumerablestring).
...
Result-producing counterpart of
[`MessageDispatchEngine.DispatchAsync(object, IServiceProvider, IDictionary<object, object?>?, CancellationToken, IEnumerable<string>?)`](/ergosfare.docs/api/core/messagedispatchengine#dispatchasyncobject-iserviceprovider-idictionaryobject-object-cancellationtoken-ienumerablestring).
