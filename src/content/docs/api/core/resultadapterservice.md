...
Implementation of [`IResultAdapterService`](/ergosfare.docs/api/core-abstractions/iresultadapterservice) that manages a collection
of [`IResultAdapter`](/ergosfare.docs/api/core-abstractions/iresultadapter) instances and provides exception lookup functionality.
...
**Implements:** [`IResultAdapterService`](/ergosfare.docs/api/core-abstractions/iresultadapterservice)
