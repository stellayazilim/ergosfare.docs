...
[`IEventExceptionInterceptor`](/ergosfare.docs/api/events-abstractions/ieventexceptioninterceptor), and the shape a global error policy takes.
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Events.Abstractions/ExceptionInterceptors/IEventExceptionInterceptorFor%5BTException%5D.cs#L21)
...
| --- | --- | --- |
| `event` | [`IEvent`](/ergosfare.docs/api/events-abstractions/ievent) | The event being processed when the exception occurred. |
