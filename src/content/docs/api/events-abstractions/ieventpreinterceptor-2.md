...
| Name | Description |
| --- | --- |
| `TEvent` | The type of the original event being intercepted. Must implement [`IEvent`](/ergosfare.docs/api/events-abstractions/ievent). |
...
This interface inherits from [`IAsyncPreInterceptor<TMessage>`](/ergosfare.docs/api/core-abstractions-handlers/iasyncpreinterceptor-1), enabling
