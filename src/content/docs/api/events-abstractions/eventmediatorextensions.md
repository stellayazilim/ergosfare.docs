...
| --- | --- | --- |
| `eventMediator` | [`IEventMediator`](/ergosfare.docs/api/events-abstractions/ieventmediator) | The [`IEventMediator`](/ergosfare.docs/api/events-abstractions/ieventmediator) used to publish the event. |
