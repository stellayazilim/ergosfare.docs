...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Commands.Abstractions/ExceptionInterceptors/ICommandExceptionInterceptorFor%5BTCommand%2CTException%5D.cs#L22)
...
implement [`ICommandExceptionInterceptorFor<TCommand, TResult, TException>`](/ergosfare.docs/api/commands-abstractions/icommandexceptioninterceptorfor-3).
