...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Commands.Abstractions/FinalInterceptors/ICommandFinalInterceptor.cs#L16)
...
implement [`ICommandFinalInterceptor<TCommand>`](/ergosfare.docs/api/commands-abstractions/icommandfinalinterceptor-1) or
