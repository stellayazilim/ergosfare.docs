...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Commands.Abstractions/ICommandMediator.cs#L13)

## Remarks

Everything a dispatch needs is passed as an argument. Only the four overloads that take
`IEnumerable<string>` groups or an [`ErgosfareContext`](/ergosfare.docs/api/core-abstractions/ergosfarecontext) are abstract;
