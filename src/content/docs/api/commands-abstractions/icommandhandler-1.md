...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Commands.Abstractions/Handlers/ICommandHandler%5BTCommand%5D.cs#L14)
...
fails the dispatch. Implement [`ICommandHandler<TCommand, TResult>`](/ergosfare.docs/api/commands-abstractions/icommandhandler-2) for a
