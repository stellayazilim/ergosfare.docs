...
[`StagedResultPlan`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan) closed over its message and result types; generated
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/StagedPlans/StagedResultPlan%5BTMessage%2CTResult%5D.cs#L10)
...
**Inherits:** [`object`](https://learn.microsoft.com/dotnet/api/system.object), [`StagedResultPlan`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan)

**Implements:** `IPipelineExecutor<TResult>`, [`ICompiledPlan`](/ergosfare.docs/api/core-abstractions-stagedplans/icompiledplan)
...
[`StagedResultPlan.Composition`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan#composition).
...
Only called on a plan that reports [`StagedResultPlan.FilterGroups`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan#filtergroups). The
