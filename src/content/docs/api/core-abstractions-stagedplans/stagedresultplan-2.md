...
The typed closure of [`StagedResultPlan`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan); subclassed by generated (or hand-written) plans.

```csharp
public abstract class StagedResultPlan<TMessage, TResult> : StagedResultPlan where TMessage : IMessage
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/StagedPlans/StagedResultPlan%5BTMessage%2CTResult%5D.cs#L4)
