...
Generic re-entry point for consumers of [`StagedResultPlan`](/ergosfare.docs/api/core-abstractions-stagedplans/stagedresultplan).

```csharp
public interface IStagedResultPlanVisitor<out TReturn, in TState>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/StagedPlans/IStagedResultPlanVisitor.cs#L3)
