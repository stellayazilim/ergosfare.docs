...
Generic re-entry point for consumers of [`ResultPlanRoot`](/ergosfare.docs/api/core-abstractions/resultplanroot).

```csharp
public interface IResultPlanRootVisitor<out TReturn, in TState>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/GeneratedDispatchRoots.cs#L247)
