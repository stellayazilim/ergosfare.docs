...
Generic re-entry point for consumers of [`VoidPlanRoot`](/ergosfare.docs/api/core-abstractions/voidplanroot).

```csharp
public interface IVoidPlanRootVisitor<out TReturn, in TState>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/GeneratedDispatchRoots.cs#L202)
