...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/IMessageMediator.cs#L8)
...
[`IMessageMediator.DispatchAsync(object, ErgosfareContext, IEnumerable<string>?)`](/ergosfare.docs/api/core-abstractions/imessagemediator#dispatchasyncobject-ergosfarecontext-ienumerablestring).
...
[`IMessageMediator.DispatchAsync(object, IDictionary<object, object?>?, CancellationToken, IEnumerable<string>?)`](/ergosfare.docs/api/core-abstractions/imessagemediator#dispatchasyncobject-idictionaryobject-object-cancellationtoken-ienumerablestring).
