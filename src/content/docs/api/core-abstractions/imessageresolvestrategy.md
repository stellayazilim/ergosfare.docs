...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/IMessageResolveStrategies.cs#L4)
...
[`IMessageDescriptor`](/ergosfare.docs/api/core-abstractions-registry-descriptors/imessagedescriptor) — The message descriptor if found; otherwise, `null`.
