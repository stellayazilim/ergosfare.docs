...
context's lifetime; [`MediateOptions<TMessage, TResult>.Items`](/ergosfare.docs/api/core-abstractions/mediateoptions-2#items) and [`MediateOptions<TMessage, TResult>.CancellationToken`](/ergosfare.docs/api/core-abstractions/mediateoptions-2#cancellationtoken) are
ignored in favor of the context's own state.

**Returns**

[`IExecutionContext`](/ergosfare.docs/api/core-abstractions/iexecutioncontext)
...
[`IMessageResolveStrategy`](/ergosfare.docs/api/core-abstractions/imessageresolvestrategy)
