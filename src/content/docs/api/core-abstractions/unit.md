...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Unit.cs#L9)
...
including void dispatches. On those paths they receive [`Unit.Value`](/ergosfare.docs/api/core-abstractions/unit#value).
