...
passes [`ExecutionContextScope.Context`](/ergosfare.docs/api/core-abstractions/executioncontextscope#context) to the inner mediator call, and disposes the scope when
...
[View source](https://github.com/stellayazilim/ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Context/ExecutionContextScope.cs#L18)
