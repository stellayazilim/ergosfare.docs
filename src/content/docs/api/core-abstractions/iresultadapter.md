...
[View source](https://github.com/stellayazilim/ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/IResultAdapter.cs#L23)
...
Multiple adapters can be registered in an [`IResultAdapterService`](/ergosfare.docs/api/core-abstractions/iresultadapterservice), and
...
This method should only be called after [`IResultAdapter.CanAdapt(object)`](/ergosfare.docs/api/core-abstractions/iresultadapter#canadaptobject) returns `true`
