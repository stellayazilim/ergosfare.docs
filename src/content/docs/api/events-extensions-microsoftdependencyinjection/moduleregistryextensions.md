...
| `builder` | `Action<EventModuleBuilder>` | An action to configure the [`EventModuleBuilder`](/ergosfare.docs/api/events-extensions-microsoftdependencyinjection/eventmodulebuilder), allowing registration of events in the message registry. |
