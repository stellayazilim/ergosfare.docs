...
Evaluates the discovery attributes at runtime — [`ExcludeFromDiscoveryAttribute`](/ergosfare.docs/api/core-abstractions-attributes/excludefromdiscoveryattribute),
[`DiscoveryKeyAttribute`](/ergosfare.docs/api/core-abstractions-attributes/discoverykeyattribute), and the key patterns registration calls pass.
...
[`DiscoveryKeyAttribute.DefaultKey`](/ergosfare.docs/api/core-abstractions-attributes/discoverykeyattribute#defaultkey).
