...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Attributes/GroupAttribute.cs#L15)
...
A participant without this attribute belongs to [`GroupAttribute.DefaultGroupName`](/ergosfare.docs/api/core-abstractions-attributes/groupattribute#defaultgroupname) alone.
...
lists [`GroupAttribute.DefaultGroupName`](/ergosfare.docs/api/core-abstractions-attributes/groupattribute#defaultgroupname) explicitly.
