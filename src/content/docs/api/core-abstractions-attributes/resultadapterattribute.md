...
Declares, on a message type, the [`IResultAdapter<TResult>`](/ergosfare.docs/api/core-abstractions/iresultadapter-1) that surfaces
...
[`Result`](/ergosfare.docs/api/core-abstractions/result)/[`Result<TValue>`](/ergosfare.docs/api/core-abstractions/result-1) carriers need no annotation (they
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Attributes/ResultAdapterAttribute.cs#L19)
