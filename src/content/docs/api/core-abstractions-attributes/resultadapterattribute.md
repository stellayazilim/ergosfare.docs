...
Binds a message type to the [`IResultAdapter<TResult>`](/ergosfare.docs/api/core-abstractions/iresultadapter-1) that reads
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Attributes/ResultAdapterAttribute.cs#L26)
...
The adapter type must implement [`IResultAdapter<TResult>`](/ergosfare.docs/api/core-abstractions/iresultadapter-1) for the message's
...
[`Result`](/ergosfare.docs/api/core-abstractions-results/result) or [`Result<TValue>`](/ergosfare.docs/api/core-abstractions-results/result-1) needs no annotation — those bind to
