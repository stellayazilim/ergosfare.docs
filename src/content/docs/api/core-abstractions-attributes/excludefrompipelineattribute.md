...
[View source](https://github.com/stellayazilim/ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/Attributes/ExcludeFromPipelineAttribute.cs#L15)
...
only the covariant interceptors carrying one of those [`GroupAttribute`](/ergosfare.docs/api/core-abstractions-attributes/groupattribute)
