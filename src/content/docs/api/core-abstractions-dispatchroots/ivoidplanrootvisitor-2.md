...
Generic re-entry point for consumers of [`VoidPlanRoot`](/ergosfare.docs/api/core-abstractions-dispatchroots/voidplanroot).

```csharp
public interface IVoidPlanRootVisitor<out TReturn, in TState>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/DispatchRoots/IVoidPlanRootVisitor.cs#L4)
