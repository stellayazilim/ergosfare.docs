...
Generic re-entry point for consumers of [`MessageResultRoot`](/ergosfare.docs/api/core-abstractions-dispatchroots/messageresultroot).

```csharp
public interface IMessageResultRootVisitor<out TReturn, in TState>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/main/src/Stella.Ergosfare.Core.Abstractions/DispatchRoots/IMessageResultRootVisitor.cs#L2)
