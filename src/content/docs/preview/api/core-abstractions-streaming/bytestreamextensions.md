...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Streaming/ByteStreamExtensions.cs#L13)
...
[`ErgosfareStream<TChunk>`](/ergosfare.docs/preview/api/core-abstractions-streaming/ergosfarestream-1): a stream message is a sequence, so these apply to
