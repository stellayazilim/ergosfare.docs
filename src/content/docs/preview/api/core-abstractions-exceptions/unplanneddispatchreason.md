...
[`UnplannedDispatchException`](/ergosfare.docs/preview/api/core-abstractions-exceptions/unplanneddispatchexception) so callers and tests can tell the cases apart
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Exceptions/UnplannedDispatchReason.cs#L8)
