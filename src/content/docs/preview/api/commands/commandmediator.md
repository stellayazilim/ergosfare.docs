...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Commands/CommandMediator.cs#L14)
...
| --- | --- | --- |
| `commandConstruct` | [`ICommand`](/ergosfare.docs/preview/api/commands-abstractions/icommand) | The command to send. |
