...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Extensions.MicrosoftDependencyInjection/ModuleRegistry.cs#L21)
...
| Name | Type | Description |
| --- | --- | --- |
| `builder` | `Action<ResultAdapterBuilder>` | An action that configures the [`ResultAdapterBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/resultadapterbuilder) with custom adapters. |
