...
Provides a fluent API for registering message types into the [`IMessageRegistry`](/ergosfare.docs/preview/api/core-abstractions-registry/imessageregistry).
...
**Implements:** [`IModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imodulebuilder)

## Remarks

The [`CoreModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/coremodulebuilder) is typically used inside the [`CoreModule`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/coremodule)
...
| --- | --- | --- |
| `registry` | [`IMessageRegistry`](/ergosfare.docs/preview/api/core-abstractions-registry/imessageregistry) |  |
...
Registers the specified type into the [`IMessageRegistry`](/ergosfare.docs/preview/api/core-abstractions-registry/imessageregistry).
...
[`IModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imodulebuilder) — The current [`IModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imodulebuilder) instance for fluent chaining.
...
Registers the specified generic type `T` into the [`IMessageRegistry`](/ergosfare.docs/preview/api/core-abstractions-registry/imessageregistry).
...
[`DiscoveryKeyAttribute`](/ergosfare.docs/preview/api/core-abstractions-attributes/discoverykeyattribute) for the key model.
...
excluded via [`ExcludeFromDiscoveryAttribute`](/ergosfare.docs/preview/api/core-abstractions-attributes/excludefromdiscoveryattribute) or gated behind a
[`DiscoveryKeyAttribute`](/ergosfare.docs/preview/api/core-abstractions-attributes/discoverykeyattribute) are skipped, mirroring source-generated
`RegisterGenerated()`.
