...
[`IModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imodulebuilder) — The current [`IModuleBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imodulebuilder) instance to allow for fluent chaining.
