...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Extensions.MicrosoftDependencyInjection/IModule.cs#L11)
...
| --- | --- | --- |
| `configuration` | [`IModuleConfiguration`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/imoduleconfiguration) | What the module registers into: the service collection, and the record of what this container selected. |
