...
Provides a fluent API for registering [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter) implementations
into an [`IResultAdapterService`](/ergosfare.docs/preview/api/core-abstractions/iresultadapterservice).

```csharp
public class ResultAdapterBuilder
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Extensions.MicrosoftDependencyInjection/ResultAdapterBuilder.cs#L18)
...
[`ResultAdapterBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/resultadapterbuilder) — The current [`ResultAdapterBuilder`](/ergosfare.docs/preview/api/core-extensions-microsoftdependencyinjection/resultadapterbuilder) instance for chaining.

The adapter type must implement [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter) and have a parameterless constructor.
...
| Name | Description |
| --- | --- |
| `TAdapter` | The adapter type implementing [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter). |
...
Registers all [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter) implementations found in the given assembly.
...
This scans for non-abstract, concrete classes that implement [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter).
