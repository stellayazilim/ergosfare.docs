...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Attributes/ExcludeFromPipelineAttribute.cs#L14)
...
with group names only those declaring one of the named [`GroupAttribute`](/ergosfare.docs/preview/api/core-abstractions-attributes/groupattribute)
