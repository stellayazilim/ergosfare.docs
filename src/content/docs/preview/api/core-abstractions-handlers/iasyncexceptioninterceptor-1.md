...
default implementation: the pipeline invokes [`IAsyncExceptionInterceptor<TMessage>.HandleAsync(TMessage, object?, Exception, IExecutionContext)`](/ergosfare.docs/preview/api/core-abstractions-handlers/iasyncexceptioninterceptor-1#handleasynctmessage-object-exception-iexecutioncontext) directly.
...
```csharp
ValueTask<object> HandleAsync(TMessage message, object? messageResult, Exception exception, IExecutionContext context)
```
