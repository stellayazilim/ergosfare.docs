...
implementation: the pipeline invokes [`IAsyncPreInterceptor<TMessage>.HandleAsync(TMessage, IExecutionContext)`](/ergosfare.docs/preview/api/core-abstractions-handlers/iasyncpreinterceptor-1#handleasynctmessage-iexecutioncontext) directly.
