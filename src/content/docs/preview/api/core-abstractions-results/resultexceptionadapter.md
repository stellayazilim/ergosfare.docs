...
Reads and builds the framework's [`Result`](/ergosfare.docs/preview/api/core-abstractions-results/result) carrier. Bound automatically —
...
[`Result`](/ergosfare.docs/preview/api/core-abstractions-results/result) — The failed result.
...
| Name | Type | Description |
| --- | --- | --- |
| `result` | [`Result`](/ergosfare.docs/preview/api/core-abstractions-results/result) | The result to inspect. |
