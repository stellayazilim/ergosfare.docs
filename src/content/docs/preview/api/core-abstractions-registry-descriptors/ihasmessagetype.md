...
[View source](https://github.com/stellayazilim/ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Registry/Descriptors/IHasMessageType.cs#L13)
...
[`IHasMessageType.MessageType`](/ergosfare.docs/preview/api/core-abstractions-registry-descriptors/ihasmessagetype#messagetype) property so that the message type can be
