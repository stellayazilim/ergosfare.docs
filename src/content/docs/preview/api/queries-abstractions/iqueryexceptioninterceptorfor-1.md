...
[`IQueryExceptionInterceptor`](/ergosfare.docs/preview/api/queries-abstractions/iqueryexceptioninterceptor), and the shape a global error policy takes.
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/ExceptionInterceptors/IQueryExceptionInterceptorFor%5BTException%5D.cs#L21)
...
| --- | --- | --- |
| `query` | [`IQuery`](/ergosfare.docs/preview/api/queries-abstractions/iquery) | The query being processed when the exception occurred. |
