...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/PreInterceptors/IQueryPreInterceptor%5BTQuery%5D.cs#L19)

**Type parameters**

| Name | Description |
| --- | --- |
| `TQuery` | The type of query to be intercepted. Must implement [`IQuery`](/ergosfare.docs/preview/api/queries-abstractions/iquery). |
...
[`IQueryPreInterceptor`](/ergosfare.docs/preview/api/queries-abstractions/iquerypreinterceptor) to intercept any query, or
[`IQueryPreInterceptor<TQuery, TModifiedQuery>`](/ergosfare.docs/preview/api/queries-abstractions/iquerypreinterceptor-2) to return a different, derived
