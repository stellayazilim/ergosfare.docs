...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/ExceptionInterceptors/IQueryExceptionInterceptorFor%5BTQuery%2CTException%5D.cs#L20)
...
result, implement
[`IQueryExceptionInterceptorFor<TQuery, TResult, TException>`](/ergosfare.docs/preview/api/queries-abstractions/iqueryexceptioninterceptorfor-3).
