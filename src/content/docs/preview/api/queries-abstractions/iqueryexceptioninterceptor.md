...
[View source](https://github.com/stellayazilim/ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/ExceptionInterceptors/IQueryExceptionInterceptor.cs#L17)
...
Implementations will receive queries as [`IQuery`](/ergosfare.docs/preview/api/queries-abstractions/iquery) and results as [`object`](https://learn.microsoft.com/dotnet/api/system.object).
For scenarios requiring type-safe handling of a specific query type and result type,
consider using [`IQueryExceptionInterceptor<TQuery, TResult>`](/ergosfare.docs/preview/api/queries-abstractions/iqueryexceptioninterceptor-2) instead.
