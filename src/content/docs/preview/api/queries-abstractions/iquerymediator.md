...
| --- | --- | --- |
| `query` | `IQuery<TQueryResult>` | The query to be executed. |
| `queryMediationSettings` | [`QueryMediationSettings`](/ergosfare.docs/preview/api/queries-abstractions/querymediationsettings) | Optional settings for query mediation that control aspects such as handler filtering. |
