...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/IQuery.cs#L17)

## Remarks

Any type implementing [`IQuery`](/ergosfare.docs/preview/api/queries-abstractions/iquery) is considered a query and can be registered
