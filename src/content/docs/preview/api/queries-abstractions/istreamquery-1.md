...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/IStreamQuery%5BTResult%5D.cs#L13)
...
by an [`IStreamQueryHandler<TQuery, TResult>`](/ergosfare.docs/preview/api/queries-abstractions/istreamqueryhandler-2), and items are produced as the
