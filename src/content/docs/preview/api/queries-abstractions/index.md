...
The `Stella.Ergosfare.Queries.Abstractions` namespace contains 20 public types.
...
| [`IQueryMediator`](/ergosfare.docs/preview/api/queries-abstractions/iquerymediator) | Interface | Represents the mediator interface for executing queries within the application. |
...
| [`StreamRevision`](/ergosfare.docs/preview/api/queries-abstractions/streamrevision) | Class | The notice carried by the streaming entry points while the shape of stream messaging is being revised. |
