...
| [`IQueryPostInterceptor<TQuery>`](/ergosfare.docs/preview/api/queries-abstractions/iquerypostinterceptor-1) | Interface | Represents a non-generic post-interceptor for queries in the Stella.Ergosfare pipeline. |
