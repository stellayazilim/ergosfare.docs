...
Provides a central service to manage multiple [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter) instances
...
Registers a new [`IResultAdapter`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter) to the service.
