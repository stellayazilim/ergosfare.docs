...
[`IResultAdapter<TResult>`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter-1).

```csharp
public interface IResultMaterializer<out TResult>
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/IResultMaterializer.cs#L22)
...
Implementing this alongside [`IResultAdapter<TResult>`](/ergosfare.docs/preview/api/core-abstractions/iresultadapter-1) changes how the
...
[`Result`](/ergosfare.docs/preview/api/core-abstractions-results/result) and [`Result<TValue>`](/ergosfare.docs/preview/api/core-abstractions-results/result-1) adapters implement it.
