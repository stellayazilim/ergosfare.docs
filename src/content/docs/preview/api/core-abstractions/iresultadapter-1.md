...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/IResultAdapter.cs#L15)
...
[`Result`](/ergosfare.docs/preview/api/core-abstractions-results/result) and [`Result<TValue>`](/ergosfare.docs/preview/api/core-abstractions-results/result-1), or a third-party type such as
