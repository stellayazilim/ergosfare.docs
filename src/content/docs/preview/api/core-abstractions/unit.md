...
take a result argument — [`Unit.Value`](/ergosfare.docs/preview/api/core-abstractions/unit#value) is what they are handed, on every path.

```csharp
public sealed class Unit
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Unit.cs#L20)
