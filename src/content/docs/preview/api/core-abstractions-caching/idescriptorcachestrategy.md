...
**Namespace:** [`Stella.Ergosfare.Core.Abstractions.Caching`](/ergosfare.docs/preview/api/core-abstractions-caching)  
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Caching/IDescriptorCacheStrategy.cs#L5)
