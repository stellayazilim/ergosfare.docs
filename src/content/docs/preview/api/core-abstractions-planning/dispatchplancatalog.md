...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/Planning/DispatchPlanCatalog.cs#L18)
...
[`DispatchPlanCatalog.SelectedParticipants()`](/ergosfare.docs/preview/api/core-abstractions-planning/dispatchplancatalog#selectedparticipants).
...
| --- | --- | --- |
| `composition` | [`PipelineDescriptor`](/ergosfare.docs/preview/api/core-abstractions-planning/pipelinedescriptor) | The composition to serve. Cannot be `null`. |
...
Records a batch of registered types; see [`DispatchPlanCatalog.Select(Type)`](/ergosfare.docs/preview/api/core-abstractions-planning/dispatchplancatalog#selecttype).
...
Every type returned came from [`FrozenParticipant.HandlerType`](/ergosfare.docs/preview/api/core-abstractions-planning/frozenparticipant#handlertype), so its
