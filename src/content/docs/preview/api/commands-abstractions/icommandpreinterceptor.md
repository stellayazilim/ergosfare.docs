...
command implementing [`ICommand`](/ergosfare.docs/preview/api/commands-abstractions/icommand). For type-safe interception, consider
using [`ICommandPreInterceptor<TCommand>`](/ergosfare.docs/preview/api/commands-abstractions/icommandpreinterceptor-1) or
[`ICommandPreInterceptor<TCommand, TModifiedCommand>`](/ergosfare.docs/preview/api/commands-abstractions/icommandpreinterceptor-2).
