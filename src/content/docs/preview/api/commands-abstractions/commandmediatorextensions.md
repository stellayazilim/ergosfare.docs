...
Provides extension methods for [`ICommandMediator`](/ergosfare.docs/preview/api/commands-abstractions/icommandmediator) to simplify sending commands.
...
| --- | --- | --- |
| `commandMediator` | [`ICommandMediator`](/ergosfare.docs/preview/api/commands-abstractions/icommandmediator) | The command mediator instance. |
