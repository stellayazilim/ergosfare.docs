...
[`ICommandPreInterceptor`](/ergosfare.docs/preview/api/commands-abstractions/icommandpreinterceptor) to intercept any command (returning [`object`](https://learn.microsoft.com/dotnet/api/system.object)),
or [`ICommandPreInterceptor<TCommand, TModifiedCommand>`](/ergosfare.docs/preview/api/commands-abstractions/icommandpreinterceptor-2) to return a different,
