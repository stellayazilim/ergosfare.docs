...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Commands.Abstractions/PreInterceptors/ICommandPreInterceptor%5BTCommand%5D.cs#L17)
...
still a `TCommand`. Use [`ICommandPreInterceptor`](/ergosfare.docs/preview/api/commands-abstractions/icommandpreinterceptor) to
