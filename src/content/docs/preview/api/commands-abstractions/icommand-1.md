...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Commands.Abstractions/ICommand%5BTResult%5D.cs#L11)
...
This interface extends the base [`ICommand`](/ergosfare.docs/preview/api/commands-abstractions/icommand) interface to support commands that need to return
