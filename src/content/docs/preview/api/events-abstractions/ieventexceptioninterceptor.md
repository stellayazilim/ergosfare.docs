...
This interface is a non-generic version of [`IEventExceptionInterceptor<TEvent>`](/ergosfare.docs/preview/api/events-abstractions/ieventexceptioninterceptor-1),
applying to all events implementing [`IEvent`](/ergosfare.docs/preview/api/events-abstractions/ievent).

It inherits from [`IAsyncExceptionInterceptor<TMessage, TResult>`](/ergosfare.docs/preview/api/core-abstractions-handlers/iasyncexceptioninterceptor-2), enabling
