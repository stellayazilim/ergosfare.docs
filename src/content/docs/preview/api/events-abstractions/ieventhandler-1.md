...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Events.Abstractions/Handlers/IEventHandler.cs#L18)

**Type parameters**

| Name | Description |
| --- | --- |
| `TEvent` | The event type this handler accepts. Any non-null type will do — an event need not implement [`IEvent`](/ergosfare.docs/preview/api/events-abstractions/ievent). |
