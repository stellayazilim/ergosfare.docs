...
Publishes events. An alternative name for [`IEventMediator`](/ergosfare.docs/preview/api/events-abstractions/ieventmediator), adding nothing
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Events.Abstractions/IPublisher.cs#L6)
