...
[`StagedVoidPlan`](/ergosfare.docs/preview/api/core-abstractions-stagedplans/stagedvoidplan) closed over its message type; generated plans derive from
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/StagedPlans/StagedVoidPlan%5BTMessage%5D.cs#L9)
...
[`StagedVoidPlan.Composition`](/ergosfare.docs/preview/api/core-abstractions-stagedplans/stagedvoidplan#composition).
...
Only called on a plan that reports [`StagedVoidPlan.FilterGroups`](/ergosfare.docs/preview/api/core-abstractions-stagedplans/stagedvoidplan#filtergroups). The
