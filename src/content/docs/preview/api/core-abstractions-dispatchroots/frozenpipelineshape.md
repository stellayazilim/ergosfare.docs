...
The six executable stage arrays [`FrozenComposition.BuildShape(Type, IReadOnlyList<string>)`](/ergosfare.docs/preview/api/core-abstractions-dispatchroots/frozencomposition#buildshapetype-ireadonlyliststring) derives for
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/DispatchRoots/FrozenComposition.cs#L265)
