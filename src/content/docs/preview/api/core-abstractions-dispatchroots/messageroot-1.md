...
The concrete closure of [`MessageRoot`](/ergosfare.docs/preview/api/core-abstractions-dispatchroots/messageroot); instantiated by generated code.

```csharp
public sealed class MessageRoot<TMessage> : MessageRoot where TMessage : IMessage
```

[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Core.Abstractions/DispatchRoots/MessageRoot%5BTMessage%5D.cs#L2)
...
**Inherits:** [`object`](https://learn.microsoft.com/dotnet/api/system.object), [`MessageRoot`](/ergosfare.docs/preview/api/core-abstractions-dispatchroots/messageroot)
