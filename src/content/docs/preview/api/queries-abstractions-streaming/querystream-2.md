...
**Namespace:** [`Stella.Ergosfare.Queries.Abstractions.Streaming`](/ergosfare.docs/preview/api/queries-abstractions-streaming)  
...
[View source](https://github.com/stellayazilim/Ergosfare/blob/preview/src/Stella.Ergosfare.Queries.Abstractions/Streaming/QueryStream.cs#L9)
...
**Implements:** [`IAsyncDisposable`](https://learn.microsoft.com/dotnet/api/system.iasyncdisposable), `IAsyncEnumerable<TChunk>`, `IBufferWriter<TChunk>`, [`IQuery`](/ergosfare.docs/preview/api/queries-abstractions/iquery), [`IMessage`](/ergosfare.docs/preview/api/core-abstractions/imessage)
